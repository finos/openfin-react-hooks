...
const cards: IDemoCard[] = [
  ...
  {
    description:
      "Auto-magically send properties on the InterApplicationBus whenever they change",
    icon: "arrow_upward",
    iconRotate: false,
  ...
  {
    description:
      "Auto-magically publish properties on the InterApplicationBus whenever they change",
    icon: "publish",
    iconRotate: false,
  ...
  {
    description:
      "Listen to and update whether user movement is enabled or disabled for a window",
    icon: "pan_tool",
    iconRotate: false,
    id: "user-movement",
  ...
  {
    description:
      "Use the Channels API to send/receive messages between windows or applications",
    icon: "linear_scale",
    iconRotate: false,
    id: "channel-provider",
    name: "useChannels",
